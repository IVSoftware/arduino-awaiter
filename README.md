Looking at the intent of your code, you appear to be using `DAwaiter` as a sort of roll your own synchronization object. It might be easier to use one of the ready-made synchronization objects like [SemaphoreSlim](https://learn.microsoft.com/en-us/dotnet/api/system.threading.semaphoreslim?view=net-8.0). 
...
```
  ...
  [1]: https://i.sstatic.net/zOo1sVs5.png